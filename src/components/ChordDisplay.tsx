...
interface ChordDisplayProps {
  chordName: string;
  notes: string[];
  useFrenchNotation?: boolean;
}

const ChordDisplay: React.FC<ChordDisplayProps> = ({ chordName, notes, useFrenchNotation = false }) => {
  const displayedNotes = convertNotes(notes, useFrenchNotation);
